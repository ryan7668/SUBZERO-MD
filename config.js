...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~UgJwgDwa#hV1wT1e1PimF6So9-1tj4PHz4IdVy7nnX6FLCXOTKJ0",  //  (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2347025768767",  // Owner's WhatsApp number
